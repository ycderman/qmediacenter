...
class _MprisObject(dbus.service.Object):
    def __init__(self, bus, player_widget):
...
class MprisAdapter:
    """Create once, wire to MainWindow._play() / _on_back()."""
    ...
    def __init__(self, player_widget):
        ...
        try:
            ...
            self._obj = _MprisObject(bus, player_widget)
            loop = GLib.MainLoop()
